...
export function Shadows(){
    ...
    gui.add(ambientLight,'intensity', 0, 3, 0.001).name('Ambient Intensity')
    scene.add(ambientLight);

    //DirectionalLight
    const directionalLight = new THREE.DirectionalLight(0xffffff,1.1)
    directionalLight.position.set(2,2,-1)
    gui.add(directionalLight,'intensity', 0, 3, 0.001).name('Directional Intensity')
    ...
    // directionalLight.shadow.radius = 10; Doesnt Work except in PCFShadowMap
    ...
    const spotLight = new THREE.SpotLight(0xffffff, 2.4, 10, Math.PI * .3)
    gui.add(spotLight,'intensity', 0, 6, 0.001).name('Spot Intensity')
